  ...
  return (
    ...
    <div className='flex flex-row items-center h-full justify-center'>
        <div className="flex flex-col flex-1 justify-start items-center">
            <p className="text-center m-1 text-gray-700 text-5xl mb-4"> Yamaha Enterprises</p>
        ...
        <div className='flex flex-col flex-1 justify-start items-center'>
           <p className="text-center m-1 text-gray-700 text-5xl mb-2"> +1000 compras</p>
           <p className="text-center m-1 text-gray-700 text-3xl mb-4"> Durante el ultimo año</p>
       </div>
       <div className="flex flex-col flex-1 justify-start items-center">
            <p className="text-center m-1 text-gray-700 text-5xl mb-4"> +300 Vehiculos</p>
